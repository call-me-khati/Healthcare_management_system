<?php // app/views/doctor/notifications.php ?>
<div class="page-header"><h2>🔔 Notifications</h2></div>
<?php if (empty($notifs)): ?>
  <div class="card text-center" style="padding:40px"><p style="font-size:32px">🔕</p><p class="text-muted mt-16">No notifications.</p></div>
<?php else: ?>
